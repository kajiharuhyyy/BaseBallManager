...
public class GameStatController {
	...
	public String listStat(
		...
		List<GameStat> gameStats = gameStatService.search(gameId, playerId, atBats,
	...
	public String newHitStat(Model model) {
	...
	public String newPitchStat(Model model) {
	...
	public String editHitStat(@PathVariable Long id, Model model) {
	...
	public String editPitchStat(@PathVariable Long id, Model model) {
		GameStat gameStat = gameStatService.getById(id);
